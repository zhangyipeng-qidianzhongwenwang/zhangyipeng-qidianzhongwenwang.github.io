<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <%@ page import="com.systop.dao.AdminLoginDao" %>
   <%@ page import="com.systop.daoimpl.AdminLoginDaoImpl" %>
   <%@ page import="com.systop.entity.AdminLogin" %>

    <%
	//实例化操作对象
	AdminLoginDao adminDao = new AdminLoginDaoImpl();
	List<AdminLogin> list = adminDao.adminLoginFinAll();
