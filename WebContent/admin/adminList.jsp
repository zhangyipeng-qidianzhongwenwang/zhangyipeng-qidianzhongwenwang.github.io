<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <%@ page import="com.systop.daoimpl.AdminDaoImpl" %>
                              ...
                              <tbody>
                               <c:forEach items="${list }" var="admin" varStatus="s">                           
                                <tr>
                                  ...
                                  <td>${admin.getA_password() }</td>                                
                                   
                                    <td class="td-manage">
                                     <a onclick="member_stop(this,'${admin.getId() }')" href="javascript:;"  title="禁用">
                                        <i class="layui-icon">&#xe62f;</i>
                                      </a>
                                      <a onclick="member_start(this,'${admin.getId() }')" href="javascript:;"  title="启用">
                                        <i class="layui-icon">&#xe601;</i>
                                      </a>
                                    </a>
                                    <a title="编辑"  onclick="xadmin.open('编辑','./adminEdit.jsp?id='+${admin.getId() },600,400)" >
                                      <i class="layui-icon">&#xe642;</i>
                                    </a>
                                    <a title="删除" onclick="member_del(this,${admin.getId() })" href="javascript:;">
                                      <i class="layui-icon">&#xe640;</i>
                                    </a>
                                  </td>
                                </tr>
