...
<html class="x-admin-sm">
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" method="post" action="/起点中文网/adminEdit">
                <div class="layui-form-item">
                        <label for="L_account" class="layui-form-label">
                            <span class="x-red">*</span>ID</label>
                        <div class="layui-input-inline">
                            <input type="text" id="L_account" name="id"  required="" lay-verify="id" autocomplete="off" class="layui-input" value=${aid }   onfocus=this.blur()></div><br/>
                    </div>
                    <div class="layui-form-item">
                        <label for="L_account" class="layui-form-label">
